...
class _SearchPlacesScreenState extends State<SearchPlacesScreen>
{
  ...
  void findPlaceAutoCompleteSearch(String inputText) async
  {
    ...
    {
      String urlAutoCompleteSearch = "https://maps.googleapis.com/maps/api/place/autocomplete/json?input=$inputText&key=AIzaSyB_8L6k1f0T1wHaV6oI5l3vH6WLRzRScGM&components=country:TUR";
